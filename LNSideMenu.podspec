...
Pod::Spec.new do |s|
  s.name             = 'LNSideMenu'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LNSideMenu.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/LNSideMenu'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Luan Nguyen' => 'luan.nguyenkhoa@asnet.com.vn' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/LNSideMenu.git', :tag => s.version.to_s }
